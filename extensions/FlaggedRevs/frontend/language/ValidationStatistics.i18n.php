...
$messages['el'] = array(
	...
	'validationstatistics-users' => "'''{{SITENAME}}''' αυτή τη στιγμή έχει '''[[Special:ListUsers/editor|$1]]''' {{PLURAL:$1|χρήστη|χρήστες}} με δικαιώματα [[{{MediaWiki:Validationpage}}|Συντάκτη]]

Οι Συντάκτες είναι καθιερωμένοι χρήστες που μπορούν να ελέγχουν τις αναθεωρήσεις μίας σελίδας.",
	'validationstatistics-lastupdate' => "''Τα παρακάτω στοιχεία ενημερώθηκαν  τελευταία φορά στις $1 του $2 .''",
	'validationstatistics-pndtime' => "Επεξεργασίες που έχουν ελεγχθεί από αναγνωρισμένους χρήστες θεωρούνται \"επιθεωρημένες\". 

Ο μέσος όρος καθυστέρησης επιθεώρησης για [[Special:OldReviewedPages|σελίδες επεξεργασίες των οποίων εκκρεμεί επιθεώρηση]] είναι '''\$1'''. Η καθυστέρηση υπολογίζεται από το πόσο χρόνο η παλαιότερη εκκρεμής επεξεργασία έχει παραμείνει μη επιθεωρημένη.",
	'validationstatistics-revtime' => "Ο μέσος όρος αναμονής για επεξεργασίες από ''χρήστες που δεν έχουν κάνει είσοδο'' για να επιθεωρηθούν είναι '''$1''' και ο διάμεσος είναι '''$2'''.
$3",
...
$messages['hif-latn'] = array(
	'validationstatistics-user' => 'Sadasya',
);
...
$messages['si'] = array(
	...
	'validationstatistics-latest' => 'සම්මුර්තයි',
	'validationstatistics-synced' => 'සම්මුර්තයි/නිරික්ෂිතයි',
