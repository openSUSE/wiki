...
$messages['en'] = array(
	...
	'problemchanges-list' => 'This page lists [[{{MediaWiki:Validationpage}}|reviewed]] pages having one or more tagged edits awaiting review. A list of [[Special:Tags|valid change tags]] is available.',
...
Lisćina [[Special:Tags|płaśiwych změnowych markow]] stoj k dispoziciji.',
...
$messages['el'] = array(
	...
	'problemchanges-list' => "Η σελίδα αυτή καταλογογραφεί  [[{{MediaWiki:Validationpage}}|επιθεωρημένες]] σελίδες που έχουν μια ή περισσότερες επεξεργασίες με την ετικέτα ότι εκκρεμεί γι'αυτές επιθεώρηση. Είναι διαθέσιμη επίσης μια λίστα των [[Special:Tags|έγκυρων ετικετών αλλαγής]].",
	'problemchanges-legend' => 'Κατάλογος  σελίδων με  επεξεργασίες που φέρουν την ετικέτα ότι εκκρεμεί για αυτές επιθεώρηση',
...
$messages['fr'] = array(
	...
	'problemchanges-list' => "Cette page liste les [[{{MediaWiki:Validationpage}}|pages en révision]] ayant une ou plusieurs modifications en attente d'une révision. Une liste des [[Special:Tags|balises autorisées]] est disponible.",
...
Lisćina [[Special:Tags|płaćiwych změnowych markow]] k dispoziciji steji.',
...
En Leß met de [[Special:Tags|jöltejje Makeeronge för Änderonge]] ham_mer och.',
...
$messages['nl'] = array(
	...
	'problemchanges-list' => "Op deze pagina worden [[{{MediaWiki:Validationpage}}|gecontroleerde]] pagina's weergegeven die nieuwe ongecontroleerde versies met labels hebben. Er is een [[Special:Tags|lijst met geldige wijzigingslabels]] beschikbaar.",
...
$messages['pt'] = array(
	...
	'problemchanges-list' => 'Esta página lista as [[{{MediaWiki:Validationpage}}|páginas sujeitas a revisão]] com uma ou mais edições pendentes assinaladas com etiquetas de edição. Pode encontrar uma lista das etiquetas de edição válidas em [[Special:Tags]].',
	'problemchanges-legend' => 'Listar páginas com edições assinaladas a aguardar revisão',
...
$messages['ru'] = array(
	...
	'problemchanges-list' => 'На этой странице перечислены  [[{{MediaWiki:Validationpage}}|проверенные]] страницы, имеющие помеченные правки, ожидающие проверки. См. список [[Special:Tags|допустимых меток]].',
