...
Ti belki tewr verni de vurnayişan teqib biki ya na "peyser bêri".',
	...
	'revreview-reject-cancel' => 'Bıtexelne',
...
$messages['el'] = array(
	...
	'revreview-failed' => "''' Δεν είναι δυνατή η προβολή αυτής της αναθεώρησης.'' '",
	...
	'review_not_flagged' => 'Ο στόχος της αναθεώρησης δεν έχει στην παρούσα φάση επισημανθεί ως επιθεωρημένος.',
	'review_too_low' => 'Η αλλαγή δεν μπορεί να επιθεωρηθεί όταν κάποια πεδία έχουν μείνει "κενά".',
	'review_bad_key' => 'Μη έγκυρο κλειδί παραμέτρου συμπερίληψης.',
	...
	'review_cannot_undo' => 'Δεν μπορούμε να αναιρέσουμε αυτές τις αλλαγές επειδή περαιτέρω εκρεμμείς επεξεργασίες άλλαξαν τις ίδιες περιοχές.',
	...
	'revreview-check-flag-p-title' => 'Αποδεχτείτε το αποτέλεσμα των εκκρεμών αλλαγών που έχετε κάνει εδώ. Χρησιμοποιείστε αυτή τη δυνατότητα μόνον αν έχετε ήδη δει τις διαφορές των επεξεργασιών των εκκρεμών αλλαγών.',
	'revreview-check-flag-u' => 'Αποδοχή αυτής της μη ελεγμένης σελίδας',
	'revreview-check-flag-u-title' => 'Εγκρίνετε αυτήν την έκδοση της σελίδας. Χρησιμοποιείστε την μόνο αν έχετε ήδη δει όλη τη σελίδα.',
...
Δες τον [[Special:Unreviewedpages|κατάλογο των μη επιθεωρημένων σελίδων]].',
	'revreview-stable1' => 'Μπορεί να θέλετε να προβάλετε [{{fullurl:$1|stableid =$2}} αυτήν την επισημασμένη έκδοση] και να δείτε αν είναι τώρα η [{{fullurl:$1|stable=1}} σταθερή έκδοση] αυτής της σελίδας.',
	'revreview-stable2' => 'Μπορεί να θέλετε να δείτε την  [{{fullurl:$1|stable=1}} σταθερή έκδοση] αυτής της σελίδας.',
	'revreview-submit' => 'Υποβολή',
	'revreview-submitting' => 'Υποβολή ...',
	'revreview-submit-review' => 'Αποδοχή αναθεώρησης',
	'revreview-submit-unreview' => 'Μη αποδοχή αναθεώρησης',
	...
	'revreview-successful' => "'''Η αναθεώρηση του  [[:$1|$1]] έχει επιτυχώς επισημανθεί. ([{{fullurl:{{#Special:ReviewedVersions}}|page=$2}} προβολή επιθεωρημένων εκδόσεων])'''",
	'revreview-successful2' => "'''Η αναθεώρηση του [[:$1|$1]] έχει επιτυχώς αποσημανθεί.'''",
	...
	'revreview-adv-reviewing-p' => 'Προειδοποίηση: Άλλοι επιθεωρητές μπορούν να δουν ότι {{GENDER:$1|εσείς}} επιθεωρείτε αυτή τη  σελίδα.',
	'revreview-adv-reviewing-c' => 'Προειδοποίηση: Άλλοι επιθεωρητές μπορούν να δουν ότι {{GENDER:$1|εσείς}} επιθεωρείτε αυτή τη  σελίδα.',
	'revreview-sadv-reviewing-p' => 'Μπορείτε να  $1  μόνος σας επιθεωρώντας αυτή τη σελίδα σε άλλους χρήστες.',
...
به منظور حذف وضعیت بازبینی یک نسخه، روی «{{int:revreview-submit-unreview}}» کلیک کنید.
...
$messages['fi'] = array(
	...
	'review_conflict_oldid' => 'Joku on jo hyväksynyt tai hylännyt tämän version sillä aikaa, kun tarkastelit sitä.',
...
Katso [[Special:Unreviewedpages|lista sivuista, joita ei ole arvioitu]].',
	...
	'revreview-adv-reviewing-p' => 'Huomautus: Muut seulojat näkevät, että {{GENDER:$1|arvioit}} tätä sivua.',
	'revreview-adv-reviewing-c' => 'Huomautus: Muut seulojat näkevät, että {{GENDER:$1|arvioit}} näitä muutoksia.',
...
Vexa a [[Special:Unreviewedpages|lista de páxinas sen revisar]].',
	...
	'revreview-adv-reviewing-p' => 'Aviso: Os outros revisores poden ver que {{GENDER:$1|vostede}} está a revisar esta páxina.',
	'revreview-adv-reviewing-c' => 'Aviso: Os outros revisores poden ver que {{GENDER:$1|vostede}} está a revisar estes cambios.',
...
$messages['hu'] = array(
	...
	'revreview-check-flag-u' => 'Ellenőrzött lap közzététele',
...
Lásd az [[Special:Unreviewedpages|ellenőrizetlen lapok listáját]].',
	...
	'revreview-adv-stop-link' => 'jelzés visszavonása',
...
$messages['ja'] = array(
	...
	'revreview-check-flag-p' => 'この版を承認する (保留中の $1 {{PLURAL:$1|回の変更}}を含む)',
...
$messages['ka'] = array(
	...
	'revreview-check-flag-p' => 'ამ ვერსიის დამოწმება ($1 {{PLURAL:$1|შეუმოწმებელი ცვლილება|შეუმოწმებელი ცვლილება}})',
...
იხილეთ [[Special:Unreviewedpages|შეუმოწმებელი გვერდების სია]].',
	...
	'revreview-adv-reviewing-p' => 'შენიშვნა: სხვა შემმოწმებლები ხედავენ, რომ {{GENDER:$1|თქვენ}} ამოწმებთ ამ გვერდს.',
	'revreview-adv-reviewing-c' => 'შენიშვნა: სხვა შემმოწმებლები ხედავენ, რომ {{GENDER:$1|თქვენ}} ამოწმებთ ამ ცვლილებებს.',
	...
	'revreview-update-includes' => 'განახლებული თარგები/ფაილები (შეუმოწმებლები გამოყოფილია მუქად):',
	'revreview-reject-summary' => 'რეზიუმე:',
	'revreview-reject-confirm' => 'ამ ცვლილების გაუქმება',
	'revreview-reject-cancel' => 'გაუქმება',
	'revreview-reject-summary-cur' => '$2-ის {{PLURAL:$1|ბოლო ტექსტური ცვლილება|$1 ბოლო ტექსტური ცვლილებები}} გაუქმდა და აღდგა $3 ვერსია შეიცვლება წინა $4 ვერსიით',
	'revreview-reject-summary-old' => '$2-ის პირველი {{PLURAL:$1|ტექსტური ცვლილება|$1 ტექსტური ცვლილებები}}, გაუქმდა, $3 რომელიც ვერსია $4-ს მოსდევდა',
	'revreview-reject-summary-cur-short' => '{{PLURAL:$1|ბოლო ტექსტური ცვლილება|$1 ბოლო ტექსტური ცვლილებები}} გაუქმდა და $2 ვერსია დაბრუნდება $3 ვერსიაზე',
	'revreview-reject-summary-old-short' => 'პირველი {{PLURAL:$1|ტექსტური ცვლილება|$1 ტექსტური ცვლილება}} გაუქმდა, რომელიც ვერსია $2,  $3-ს მოსდევდა',
...
[[Special:Unreviewedpages|검토되지 않은 문서 목록]]을 참조하십시오.',
	...
	'revreview-adv-reviewing-c' => '알림: 다른 평론가가 {{GENDER:$1|당신}}이 이 바뀜을 검토하는 것을 볼 수 있습니다.',
...
[[Special:Unreviewedpages|സംശോധനം ചെയ്യാത്ത താളുകളുടെ പട്ടിക]] കാണുക.',
	...
	'revreview-adv-reviewing-p' => 'ശ്രദ്ധിക്കുക: മറ്റ് സംശോധകർക്ക് {{GENDER:$1|താങ്കൾ}} ഈ താൾ സംശോധനം ചെയ്യുന്നുണ്ടെന്ന് കാണാവുന്നതാണ്.',
	'revreview-adv-reviewing-c' => 'ശ്രദ്ധിക്കുക: മറ്റ് സംശോധകർക്ക് {{GENDER:$1|താങ്കൾ}} ഈ മാറ്റങ്ങൾ സംശോധനം ചെയ്യുന്നുണ്ടെന്ന് കാണാവുന്നതാണ്.',
	'revreview-sadv-reviewing-p' => 'ഈ താൾ സംശോധനം ചെയ്ത് മറ്റുള്ളവർക്ക് സഹായമാകാമെന്ന് താങ്കൾ തന്നെ $1.',
...
Sila lihat [[Special:Unreviewedpages|senarai laman yang belum diperiksa]].',
	...
	'revreview-adv-reviewing-p' => 'Peringatan: Peninjau lain boleh melihat {{GENDER:$1|anda}} mengkaji semula laman ini.',
	'revreview-adv-reviewing-c' => 'Peringatan: Peninjau lain boleh melihat {{GENDER:$1|anda}} mengkaji semula perubahan ini.',
...
Zie de [[Special:Unreviewedpages|lijst met ongecontroleerde pagina's]].",
	...
	'revreview-adv-reviewing-p' => 'Let op: andere gebruikers zien dat {{GENDER:$1|u}} bezig bent met het beoordelen van deze pagina.',
	'revreview-adv-reviewing-c' => 'Let op: andere gebruikers zien dat {{GENDER:$1|u}} bezig bent met het beoordelen van deze wijzigingen.',
...
$messages['ru'] = array(
	...
	'review_no_oldid' => 'Не указан идентификатор версии.',
...
См. [[Special:Unreviewedpages|список непроверенных страниц]].',
	...
	'revreview-adv-reviewing-p' => 'Предупреждение. Другие рецензенты могут видеть, что {{GENDER:$1|вы}} проверяете эту страницу.',
	'revreview-adv-reviewing-c' => 'Предупреждение. Другие рецензенты могут видеть, что {{GENDER:$1|вы}} проверяете эти изменения.',
...
$messages['rue'] = array(
	...
	'revreview-check-flag-u-title' => 'Прияти тоту верзію сторінкы. Хоснуйте лем кідь сьте уж видїли цїлу сторінку.',
...
Oglejte si [[Special:Unreviewedpages|seznam nepregledanih strani]].',
	...
	'revreview-adv-reviewing-p' => 'Obvestilo: Drugi pregledovalci lahko vidijo, da {{GENDER:$1|pregledujete}} to stran.',
	'revreview-adv-reviewing-c' => 'Obvestilo: Drugi pregledovalci lahko vidijo, da {{GENDER:$1|pregledujete}} te spremembe.',
...
$messages['uk'] = array(
	...
	'review_cannot_undo' => 'Не можна скасувати ці зміни, тому що подальші редагування, що очікують на перевірку, змінили ці фрагменти.',
	...
	'revreview-check-flag-p-title' => 'Підтвердити всі зміни, що в даний час очікують на перевірку, разом з вашою власною зміною. Використовуйте тільки у випадку, якщо ви вже переглянули відмінності, внесені цими змінами.',
...
Див. також [[Special:Unreviewedpages|список неперевірених сторінок]].',
	...
	'revreview-adv-reviewing-p' => 'Примітка: Інші рецензенти можуть бачити, що {{GENDER:$1|Ви}} рецензуєте цю сторінку.',
	'revreview-adv-reviewing-c' => 'Примітка: Інші рецензенти можуть бачити, що {{GENDER:$1|Ви}} рецензуєте ці редагування.',
...
Щоб зняти статус рецензування, натисніть «{{int:revreview-submit-unreview}}».
...
参见[[Special:Unreviewedpages|未复审页面列表]]。',
	...
	'revreview-adv-reviewing-p' => '注意：其他复审员可以看到{{GENDER:$1|您}}正在审阅本页。',
	'revreview-adv-reviewing-c' => '注意：其他复审员可以看到{{GENDER:$1|您}}正在审阅这些更改。',
