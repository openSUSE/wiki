...
$messages['be-tarask'] = array(
	'configuredpages' => 'Старонкі з наладамі рэцэнзаваньня',
	'configuredpages-list' => 'Ніжэй пададзены сьпіс старонак, якія маюць налады зацьверджаньня, якія адрозьніваюцца ад наладаў сайта па змоўчваньні.
Некаторыя налады могуць зьмяняць вэрсію, якая паказваецца чытачам, ці абмяжоўваць кола ўдзельнікаў, рэдагаваньні якіх не патрабуюць рэцэнзаваньня.',
 ...
 */
$messages['bg'] = array(
	'configuredpages-list' => 'Тази страница извежда списък на страниците, конфигурирани с настройки за одобрение, различни от настройките по подразбиране. 
Някои настройки могат да окажат влияние върху версията, която се показва на читателите, или допълнително да ограничат кръга от хора, които могат да редактират страницата без нужда да бъдат рецензирани.',
	'configuredpages-none' => 'Няма страници в този списък.',
 ...
 */
$messages['fa'] = array(
	'configuredpages' => 'صفحه‌های دارای تنظیمات بازبینی',
	'configuredpages-list' => 'این صفحه فهرستی از صفحه‌های تنظیم شده‌ای وجود دارد که تاییدهٔ متفاوتی از پیش‌فرض تارنما دارند.
...
Некоторые параметры могут указывать на то, какая версия отображается для читателей, либо ограничить дальнейшее внесение не требующих проверки изменений.',
...
$messages['rue'] = array(
	...
	'configuredpages-list' => 'Дале є список сторінок, котры мають іншы наставлїня схвалёваня як штандартны наставлїня.
Дакотры параметры можуть міняти, котру верзію указовати чітателям або хто може вносити зміны, котрым не треба перевіркы.',
...
$messages['ta'] = array(
	...
	'configuredpages-list' => 'கீழே கொடுத்துள்ள பட்டியலானது, இத்தளத்தின் பொதுவான அனுமதிகளில் இருந்து மாறுபட்டவைகளை குறிப்பிடுகின்றது.  மேலும் குறிப்பிட்ட சிலருக்கு தொகுத்த பின் அதனை மறுபார்வை செய்ய வேண்டிய அவசியம் இல்லை.',
