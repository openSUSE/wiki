...
Неадпаведныя файлы будуць выдалены неадкладна, глядзіце [[{{MediaWiki:Multipleupload-page}}|правілы выдаленьня фалаў]].",
	...
	'multiupload-source' => 'Крынічныя файлы',
	'multiupload-description' => 'Апісаньне файла',
	'multiupload-options' => 'Налады загрузкі',
	'multiupload-successful-upload' => 'Загрузка пасьпяхова скончылася',
);
 ...
 */
$messages['et'] = array(
	'multipleupload' => 'Laadi üles mitu faili',
	'multipleupload-saveallfiles' => 'Salvesta kõik failid',
	'multiupload-fileuploaded' => 'Fail on üles laaditud.',
	...
	'multiupload-description' => 'Faili kirjeldus',
);
...
پرونده‌های نامناسب فوراً حذف خواهند شد، [[{{MediaWiki:Multipleupload-page}}|سیاست حذف تصاویر]] را ببینید.",
	...
	'multiupload-successful-upload' => 'بارگذاری موفق',
);
...
Sopimattomat tiedostot poistetaan välittömästi; katso [[{{MediaWiki:Multipleupload-page}}|tiedostojen poistokäytäntö]].",
	...
	'multiupload-description' => 'Tiedoston kuvaus',
	'multiupload-options' => 'Tallennusasetukset',
	'multiupload-successful-upload' => 'Tallennus onnistui',
);
...
$messages['frp'] = array(
	...
	'multiupload-source' => 'Fichiérs sôrsa',
	'multiupload-description' => 'Dèscripcion du fichiér',
	'multiupload-options' => 'Chouèx de tèlèchargement',
	'multiupload-successful-upload' => 'Tèlèchargement fêt avouéc reusséta',
);
...
Os ficheiros inapropiados eliminaranse inmediatamente: vexa a [[{{MediaWiki:Multipleupload-page}}|política de eliminación de ficheiros]].",
	...
	'multiupload-source' => 'Ficheiros de orixe',
	'multiupload-description' => 'Descrición do ficheiro',
	'multiupload-options' => 'Opcións de carga',
	'multiupload-successful-upload' => 'A carga realizouse correctamente',
);
...
קבצים לא מתאימים יימחקו מיידית, עיינו ב[[{{MediaWiki:Multipleupload-page}}|מדיניות מחיקת הקבצים]].",
	...
	'multiupload-source' => 'קבצי המקור',
	'multiupload-description' => 'תיאור הקובץ',
	'multiupload-options' => 'אפשרויות העלאה',
	'multiupload-successful-upload' => 'העלאה מוצלחת',
);
...
Njepřihódne wobrazy budu so hnydom wušmórować, hlej [[{{MediaWiki:Multipleupload-page}}|prawidła za wušmórnjenje wobrazow]].",
	...
	'multiupload-source' => 'Žórłowe dataje',
	'multiupload-description' => 'Datajowe wopisanje',
	'multiupload-options' => 'Nahrawanske opcije',
	'multiupload-successful-upload' => 'Dataja bu wuspěšnje nahrata',
);
...
File inappropriati verranno cancellati immediatamente, leggi le [[{{MediaWiki:Multipleupload-page}}|regole per la cancellazione dei file]].",
	...
	'multiupload-source' => 'File di origine',
	'multiupload-description' => 'Descrizione del file',
	'multiupload-options' => 'Opzioni di caricamento',
	'multiupload-successful-upload' => 'Caricamento completato',
);
 ...
 */
$messages['ka'] = array(
	'multipleupload-saveallfiles' => 'ყველა ფაილის შენახვა',
	'multipleupload-page' => '{{ns:project}}:ფაილების წაშლის წესები',
	'multiupload-fileuploaded' => 'ფაილი ატვირთულია.',
	'multiupload-toolbox' => 'რამდენიმე ფაილის ატვირთვა',
	'multiupload-no-files' => 'გთხოვთ, ასატვირთად აირჩიეთ სულ მცირე ერთი ფაილი მაინც',
	'multiupload-blank' => 'ფაილი არ არის არჩეული',
	'multiupload-source' => 'ფაილების წყარო',
	'multiupload-description' => 'ფაილის აღწერა',
	'multiupload-options' => 'ატვირთვის პარამეტრები',
	'multiupload-successful-upload' => 'წარმატებულად აიტვირთვა',
);
...
$messages['ko'] = array(
	...
	'multiupload-desc' => '사용자가 [[Special:MultipleUpload|한 번에 여러 파일 올리기]]를 허용',
	'multipleupload-ignoreallwarnings' => "'''모든 경고'''를 무시하고 파일을 저장합니다.",
	'multipleupload-saveallfiles' => '모든 파일 저장',
	'multipleupload-addresswarnings' => '파일을 다시 올리기 전에 경고를 해결하기 바랍니다.',
	'multipleupload-page' => '{{ns:project}}:파일 삭제 정책',
	'multipleupload-text' => "여기에 여러 파일을 올리세요.

'찾아보기'를 선택하고 올리려는 각 파일을 선택하세요.
한번에 1에서 $1까지 올릴 수 있습니다.

당신은 선택 사항으로 '''대상 파일 이름'''을 입력하고 파일을 설명하는 '''요약'''을 제공할 수 있습니다.

부적절한 파일은 즉시 삭제됩니다, [[{{MediaWiki:Multipleupload-page}}|파일 삭제 정책]]을 참고하세요.",
	...
	'multiupload-successful-upload' => '올리기 성공',
);
...
Несоодветните податотеки ќе бидат веднаш избришани; погледајте ги [[{{MediaWiki:Multipleupload-page}}|правилата за бришење на податотеки]].",
	...
	'multiupload-source' => 'Изворни податотеки',
	'multiupload-description' => 'Опис на податотека',
	'multiupload-options' => 'Нагодувања за подигање',
	'multiupload-successful-upload' => 'Подигањето е успешно',
);
...
Fail-fail yang tidak sesuai akan dihapuskan serta-merta. Sila baca [[{{MediaWiki:Multipleupload-page}}|dasar penghapusan fail]].",
	...
	'multiupload-source' => 'Fail sumber',
	'multiupload-description' => 'Keterangan fail',
	'multiupload-options' => 'Pilihan muat naik',
	'multiupload-successful-upload' => 'Muat naik berjaya',
);
...
$messages['mt'] = array(
	...
	'multiupload-no-files' => "Jekk jogħġbok agħżel minn tal-inqas fajl wieħed xi ttella'",
	'multiupload-blank' => 'L-ebda fajl ma ntgħażel',
	'multiupload-description' => 'Deskrizzjoni tal-fajl',
);
...
Zie het [[{{MediaWiki:Multipleupload-page}}|verwijderingsbeleid van bestanden]].",
	...
	'multiupload-source' => 'Bronbestanden',
	'multiupload-description' => 'Bestandsbeschrijving',
	'multiupload-options' => 'Uploadopties',
	'multiupload-successful-upload' => 'Het bestand is toegevoegd',
);
...
File pa aproprià a saran scanselà sùbit, varda la [[{{MediaWiki:Multipleupload-page}}|polìtica dë scanselassion dij file]].",
	...
	'multiupload-source' => 'Archivi sorgiss',
	'multiupload-description' => "Descrission dl'archivi",
	'multiupload-options' => 'Opsion për carié',
	'multiupload-successful-upload' => 'Carià con sucess',
);
...
$messages['ps'] = array(
	...
	'multipleupload-text' => "همدلته په يو وار ګڼې دوتنې پورته کړی.

د 'Browse' په تڼۍ کېښکاږۍ او خپل له کمپيوټر نه مو ځآنګړې دوتنه وټاکۍ.
تاسې په يو وار له 1 تر $1 دوتنې پورته کولی شی.

تاسې کولی شی چې په اختياري توګه د '''Destination filename''' او يوه '''لنډيز''' په ورکولو سره خپل د دوتنې څرګندونه هم وکړۍ.

ناوړه دوتنې به ډېر ژر ړنګې شي، د لا نورو مالوماتو لپاره [[{{MediaWiki:Multipleupload-page}}|د دوتنې د ړنګېدو تګلاره]] وګورۍ.",
	...
	'multiupload-source' => 'سرچينيزه دوتنې',
);
 ...
 */
$messages['si'] = array(
	'multipleupload-saveallfiles' => 'සියලුම ගොනු සුරකින්න',
	'multiupload-fileuploaded' => 'ගොනුව උඩුගත කරන ලදී.',
	'multiupload-toolbox' => 'බහුවිද ගොනු උඩුගත කරන්න',
	'multiupload-blank' => 'ගොනුවක් තෝරාගෙන නැත',
	'multiupload-source' => 'මූලාශ්‍ර ගොනු',
	'multiupload-description' => 'ගොනු විස්තරය',
	'multiupload-options' => 'උඩුගත කිරීම් විකල්ප',
	'multiupload-successful-upload' => 'සාර්ථක උඩුගත කිරීමකි',
);
...
$messages['sl'] = array(
	...
	'multiupload-desc' => 'Uporabnikom omogoča [[Special:MultipleUpload|hkratno nalaganje več datotek]]',
...
Neprimerne datoteke bodo nemudoma izbrisane; oglejte si [[{{MediaWiki:Multipleupload-page}}|pravilnik o izbrisu datotek]].",
	...
	'multiupload-source' => 'Izvorne datoteke',
	'multiupload-description' => 'Opis datoteke',
	'multiupload-options' => 'Možnosti nalaganja',
	'multiupload-successful-upload' => 'Uspešno nalaganje',
);
...
Opassande filer raderas omedelbart, se [[{{MediaWiki:Multipleupload-page}}|riktlinjer för filraderingar]].",
	...
	'multiupload-source' => 'Källfiler',
	'multiupload-description' => 'Filbeskrivning',
	'multiupload-options' => 'Uppladdningsalternativ',
);
...
காணவும்",
	...
	'multiupload-source' => 'மூலக்கோப்புகள்',
	'multiupload-description' => 'கோப்பின் விவரம்',
	'multiupload-options' => 'பதிவேற்றுதல் விருப்பத்தேர்வுகள்',
	'multiupload-successful-upload' => 'வெற்றிகரமான பதிவேற்றம்',
);
...
సరితగని దస్తాలు వెంటనే తొలగించబడతాయి, [[{{MediaWiki:Multipleupload-page}}|దస్త్రాల తొలగింపు విధానా]]న్ని చూడండి.",
	...
	'multiupload-source' => 'మూల దస్త్రాలు',
	'multiupload-description' => 'దస్త్రపు వివరణ',
	'multiupload-options' => 'ఎక్కింపు ఎంపికలు',
);
...
Kaagad na buburahin ang hindi naaangkop na mga talaksan, tingnan ang [[{{MediaWiki:Multipleupload-page}}|patakaran sa pagbura ng talaksan]].",
	...
	'multiupload-source' => 'Mga talaksang pinagmulan',
	'multiupload-description' => 'Paglalarawan ng talaksan',
	'multiupload-options' => 'Mga mapagpipilian ng pagkakargang papaitaas',
	'multiupload-successful-upload' => 'Matagumpay na pagkakargang papaitaas',
);
 ...
 */
$messages['ur'] = array(
	'multiupload-options' => 'اختیارات اپ لوڈ کریں',
);
...
不合适的文件会被立即删除，参见[[{{MediaWiki:Multipleupload-page}}|文件删除方针]]。",
	...
	'multiupload-source' => '来源档案',
	'multiupload-description' => '档案描述',
	'multiupload-options' => '上载选项',
...
所有不合適的檔案都會被立即刪除，詳見[[{{MediaWiki:Multipleupload-page}}|檔案刪除政策]]。",
	...
	'multiupload-source' => '來源檔案',
	'multiupload-description' => '檔案描述',
	'multiupload-options' => '上載選項',
